...
void defaultColors()async{
  var colorsNew = await AppColors.setDefaultColors();
  setState(() {colors=colorsNew;});
  widget.updateUI();
  setSaveButton();
}
  @override
...
class Choice {
  const Choice({this.title, this.colors});
...
const List<Choice> choices = const <Choice>[
  const Choice(title: 'Hoornbeeck kleuren', colors: []),
];
